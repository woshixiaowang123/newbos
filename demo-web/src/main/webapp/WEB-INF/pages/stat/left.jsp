    ...
    <div class="panel">
        ...
        <div class="panel-content">
			 <ul>
				...
				<li><a href="${ctx}/stat/statChartAction_productSale" onclick="linkHighlighted(this)" target="main" id="aa_2">产品销售排行</a></li>
				<li><a href="${ctx}/stat/statChartAction_onlineInfo" onclick="linkHighlighted(this)" target="main" id="aa_3">系统访问压力图</a></li>
			</ul>
